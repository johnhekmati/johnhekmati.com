...
**Page job:** real person under real load — martial formation as life anchor, family, hard domains — then the worlds he builds (Hekmati Consulting Group, The Cognition Factory, Form & Frame Design, Professional MMA Institute, Star Schema Publishing). Visual: elevated charcoal personal palette with steel + warm-metal life accents (not TCF electric/plasma, not FFD paper/teal, not PMMAI gold). Contact first. Not a second product or consulting site — those have their own homes.

**Faith doctrine (corrected 2026-08-05 — an earlier draft of this file said only "faith stays private", which was wrong):** the *shape* of the faith is fair game and welcome — convictions, formation, why it holds under load — especially where it helps someone else on their own path. What stays off the table is the *daily motions*: prayer life is not content and not a product. No livestreamed devotions, no lectio or stations as performance. The line is theater and monetization, not the subject itself. Authored work on faith belongs to the imprint (`starschemapublishing.com`), and by current preference is **not** linked directly from this site.
